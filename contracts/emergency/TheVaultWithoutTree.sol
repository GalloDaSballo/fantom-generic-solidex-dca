...
/// @dev Storage Slot Compatible Vault without Tree, to be used for emergency upgrades to remove the tree
...
contract VaultWithoutTree is ERC20Upgradeable, SettAccessControl, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /// Emergency Variation that maintains the override but removes the extra logic
    /// This effectively removes the badgerTree from the vault
...
contract TheVaultWithoutTree is VaultWithoutTree {
